...
public static class SimplePool
{
    ...
    public class Pool
    {
        ...
        public GameObject Spawn([Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot)
        {
            while (true)
            {
                GameObject obj;
        ...
        public T Spawn<T>([Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot)
        {
    ...
    /// call that function.
    /// </summary>
    public static GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot)
    {
        Init(prefab);
    ...
    public static T Spawn<T>(T prefab, [Bridge.Ref] Vector3 pos, [Bridge.Ref] Quaternion rot) where T : Component
    {
