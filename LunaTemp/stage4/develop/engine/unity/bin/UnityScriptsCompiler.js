...
if ( TRACE ) { TRACE( "AutoDestructor#OnDisable", this ); }
    ...
    Bridge.define("CameraController", {
        inherits: [UnityEngine.MonoBehaviour],
        fields: {
            positionOffsetIngame: null,
            newPositionOffset: null,
            target: null,
            distance: 0,
            isFollowing: false,
            offset: null,
...
if ( TRACE ) { TRACE( "CameraController#init", this ); }
                ...
                this.positionOffsetIngame = new UnityEngine.Vector3();
                this.newPositionOffset = new UnityEngine.Vector3();
...
if ( TRACE ) { TRACE( "CameraController#Init", this ); }
                ...
                this.positionOffsetIngame = this.gameObject.transform.position.$clone().sub( this.target.transform.position );
                this.newPositionOffset = this.positionOffsetIngame.$clone();

                this.distance = (this.transform.position.$clone().sub( this.target.transform.position )).length();
                this.offset = this.gameObject.transform.position.$clone().sub( this.target.transform.position );
                this.SetFollow(true);
            },
            /*CameraController.Init end.*/

            /*CameraController.SetFollow start.*/
            SetFollow: function (isFollow) {
if ( TRACE ) { TRACE( "CameraController#SetFollow", this ); }

                if (isFollow) {
                    if (UnityEngine.Component.op_Equality(this.target, null)) {
                        UnityEngine.Debug.LogError$2("Follow is true but has no Target");
                    }
            ...
            /*CameraController.SetFollow end.*/
...
if ( TRACE ) { TRACE( "CameraController#LateUpdate", this ); }
            ...
            /*CameraController.FollowTarget start.*/
            FollowTarget: function () {
if ( TRACE ) { TRACE( "CameraController#FollowTarget", this ); }

                if (!this.isFollowing) {
                    return;
                }
                this.transform.position = new pc.Vec3().lerp( this.transform.position, this.target.transform.position.$clone().add( this.newPositionOffset ), 0.07 );

            },
            /*CameraController.FollowTarget end.*/
    ...
    Bridge.define("Car", {
        ...
        fields: {
            ...
            vfxCollect: null,
            isMoving: false,
            isCarInParking: false,
            speed: 0,
            delay: 0
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Car#init", this ); }
        ...
        methods: {
            /*Car.Action start.*/
            Action: function () {
if ( TRACE ) { TRACE( "Car#Action", this ); }

                this.vfxCollect.SetActive(true);
                this.CheckPositiveAndMoveToShip();
            },
            /*Car.Action end.*/

            /*Car.CheckPositiveAndMoveToShip start.*/
            CheckPositiveAndMoveToShip: function () {
if ( TRACE ) { TRACE( "Car#CheckPositiveAndMoveToShip", this ); }

                var isMoveParkingSlot = true;
                var level = Singleton$1(GlobalInstance).Instance.gameManagerInstance.level;
                for (var i = 0; i < level.lstShip.Count; i = (i + 1) | 0) {
                    if (i === 1) {
                        break;
                    }
                    if (!level.lstShip.getItem(i).isDone) {
                        if (level.lstShip.getItem(i).CheckPositive(this.typeColor)) {
                            for (var j = 0; j < level.lstShip.getItem(i).lstBooleanSlot.Count; j = (j + 1) | 0) {
                                if (!level.lstShip.getItem(i).lstBooleanSlot.getItem(j)) {
                                    level.lstShip.getItem(i).animator.speed = 0;
                                    this.MoveToShip(level.lstShip.getItem(i).lstSlot.getItem(j).position, level.lstShip.getItem(i), j, true);
                                    level.lstShip.getItem(i).UpdateShip();
                ...
                if (isMoveParkingSlot) {
                    if (!this.isCarInParking) {
                        this.isCarInParking = true;
                        var parkingSlot = level.GetParkingSlot();
                        this.MoveToParkingSlot(parkingSlot.transform.position);
                        level.UpdateParkingSlot(this);
                        this.boxCollider.enabled = false;
                    }
                }
            },
            /*Car.CheckPositiveAndMoveToShip end.*/

            /*Car.MoveToShip start.*/
            MoveToShip: function (pos, ship, indexCarInShip, isHasDelay) {
if ( TRACE ) { TRACE( "Car#MoveToShip", this ); }

                this.isMoving = true;
                DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions), DG.Tweening.ShortcutExtensions.DORotate(this.transform, pc.Vec3.ZERO.clone(), this.speed), this.delay);
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, pos.$clone(), this.speed), DG.Tweening.Ease.Linear), this.delay), Bridge.fn.bind(this, function () {
                    this.transform.parent = ship.containCar;
                    DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                    ship.lstSlotFx.getItem(indexCarInShip).Play();
                    //PlaySoundCarIn
                    ship.animator.speed = 1;
                    if (indexCarInShip === ((ship.lstSlot.Count - 1) | 0)) {
                        ship.CheckDone();
                    }
                }));
            },
            ...
            /*Car.MoveToParkingSlot start.*/
            MoveToParkingSlot: function (pos) {
if ( TRACE ) { TRACE( "Car#MoveToParkingSlot", this ); }

                this.isMoving = true;
                DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                this.transform.parent = Singleton$1(GlobalInstance).Instance.gameManagerInstance.level.grParkingSlot;
                DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions), DG.Tweening.ShortcutExtensions.DORotate(this.transform, new pc.Vec3( 0.0, 335.0, 0.0 ), this.speed / 1.3), this.delay);
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetDelay(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMove(this.transform, pos.$clone(), this.speed / 1.3), DG.Tweening.Ease.Linear), this.delay), Bridge.fn.bind(this, function () {
                    this.StartCoroutine$1(HelperUtility.StartAction$1(Bridge.fn.bind(this, function () {
                        //Sound Go To Parking
                        this.isMoving = false;
                        this.ParkingSlotMoveToBox();
                    }), 0.05));
                }));
            },
            /*Car.MoveToParkingSlot end.*/

            /*Car.ParkingSlotMoveToBox start.*/
            ParkingSlotMoveToBox: function () {
if ( TRACE ) { TRACE( "Car#ParkingSlotMoveToBox", this ); }

                var level = Singleton$1(GlobalInstance).Instance.gameManagerInstance.level;
                if (!level.NoParkingSlot()) {
                    if (level.lstShip.getItem(0).isReady && !this.isMoving) {
                        this.Action();
                    }
                }
            },
            /*Car.ParkingSlotMoveToBox end.*/
    ...
    /*Config start.*/
    Bridge.define("Config", {
        inherits: [UnityEngine.ScriptableObject],
        fields: {
            lstObjectColor: null
        },
        methods: {
            /*Config.GetObjectColor start.*/
            GetObjectColor: function (typeColor) {
if ( TRACE ) { TRACE( "Config#GetObjectColor", this ); }

                for (var i = 0; i < this.lstObjectColor.Count; i = (i + 1) | 0) {
                    if (this.lstObjectColor.getItem(i).typeColor === typeColor) {
                        return this.lstObjectColor.getItem(i);
                    }
                }
                return null;
            },
            /*Config.GetObjectColor end.*/
...
if ( TRACE ) { TRACE( "DG.Tweening.DOTweenModuleUtils.Physics#CreateDOTweenPathTween", this ); }
    ...
    Bridge.define("EC01", {
        ...
        methods: {
            /*EC01.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "EC01#Start", this ); }
            ...
            /*EC01.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "EC01#Update", this ); }
            ...
            /*EC01.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "EC01#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*EC01.InstallFullGame end.*/
...
if ( TRACE ) { TRACE( "EventDispatcherExtension#RemoveListener", this ); }
    ...
    Bridge.define("GamePlayController", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "GamePlayController#init", this ); }
...
if ( TRACE ) { TRACE( "GamePlayController#Update", this ); }
                ...
                if (!Singleton$1(GlobalInstance).Instance.gameManagerInstance.isEndGame && Singleton$1(GlobalInstance).Instance.gameManagerInstance.isCanPlay) {
                    this.Touch();
                }
            },
            /*GamePlayController.Update end.*/

            /*GamePlayController.Touch start.*/
            Touch: function () {
if ( TRACE ) { TRACE( "GamePlayController#Touch", this ); }

                if (UnityEngine.Input.GetMouseButtonDown(0)) {
                    var rayTouch = UnityEngine.Camera.main.ScreenPointToRay(UnityEngine.Input.mousePosition);
                    if (UnityEngine.Physics.Raycast$1(rayTouch, Bridge.ref(this, "hit"), window.Infinity)) {
                        var select = this.hit.transform;
                        this.fxTap.transform.position = this.hit.point.$clone();
                        this.fxTap.gameObject.SetActive(true);
                        this.fxTap.Play();
                        Singleton$1(AudioManager).Instance.PlaySoundClick();
                    }

                    if (this.isCanRaycast) {
                        this.ray = UnityEngine.Camera.main.ScreenPointToRay(UnityEngine.Input.mousePosition);
                        if (UnityEngine.Physics.Raycast$1(this.ray, Bridge.ref(this, "hit"), window.Infinity, 64)) {
                            var select1 = this.hit.transform;
                            var stick = select1.GetComponent(Stickman);
                            stick.Action();
                            Singleton$1(GlobalInstance).Instance.gameManagerInstance.FirstTutCinema();
                            Singleton$1(GlobalInstance).Instance.gameManagerInstance.FirstInteraction();
                            Singleton$1(GlobalInstance).Instance.gameManagerInstance.UpdateTap();
                        }
                    }
                }

            },
            /*GamePlayController.Touch end.*/
...
if ( TRACE ) { TRACE( "HelperUtility#GetDirectionFromAngle", this ); }
                    ...
                    var B = HelperUtility.GetPointDistanceFromObject(1, vectorP, positionStart);
                    //Debug.Log("Distance "+ Vector3.Distance(positionStart, B));

                    var result = HelperUtility.GetPointDistanceFromObject(tanAngle, UnityEngine.Vector3.FromVector2(u), B);
...
if ( TRACE ) { TRACE( "Level#init", this ); }
                ...
                this.lstCouple = new (System.Collections.Generic.List$1(UnityEngine.GameObject)).ctor();
                this.totalCar = 0;
                this.lstShip = new (System.Collections.Generic.List$1(Ship)).ctor();
                this.lstPosShipSpawn = new (System.Collections.Generic.List$1(UnityEngine.Transform)).ctor();
                this.lstParkingSlot = new (System.Collections.Generic.List$1(ParkingSlot)).ctor();
                this.currentShip = 0;
            }
        },
        methods: {
...
if ( TRACE ) { TRACE( "Level#Init", this ); }
                ...
                for (var i = 0; i < this.lstCouple.Count; i = (i + 1) | 0) {
                    var stickMan = this.lstCouple.getItem(i).transform.GetChild(2).GetComponent(Stickman);
                    stickMan.Init();
                    this.totalCar = (this.totalCar + 1) | 0;
                }
                this.SpawnShipPredenfined(2);
            },
            /*Level.Init end.*/

            /*Level.SpawnShipPredenfined start.*/
            SpawnShipPredenfined: function (index) {
if ( TRACE ) { TRACE( "Level#SpawnShipPredenfined", this ); }

                var count = 0;
                for (var i = 0; i < this.queueShip.Count; i = (i + 1) | 0) {
                    if (count === index) {
                        break;
                    }
                    if (this.queueShip.getItem(i).typeShip === TypeShip.One) {
                        var ship = UnityEngine.Object.Instantiate(Ship, this.ShipOne, this.shipParent);
                        ship.transform.position = this.lstPosShipSpawn.getItem(i).position.$clone();
                        ship.Init(this.queueShip.getItem(i).typeColor);
                        if (i === 0) {
                            ship.isReady = true;
                        }
                        this.lstShip.add(ship);
                    } else if (this.queueShip.getItem(i).typeShip === TypeShip.Two) {
                        var ship1 = UnityEngine.Object.Instantiate(Ship, this.ShipTwo, this.shipParent);
                        ship1.transform.position = this.lstPosShipSpawn.getItem(i).position.$clone();
                        ship1.Init(this.queueShip.getItem(i).typeColor);
                        if (i === 0) {
                            ship1.isReady = true;
                        }
                        this.lstShip.add(ship1);
                    } else if (this.queueShip.getItem(i).typeShip === TypeShip.Three) {
                        var ship2 = UnityEngine.Object.Instantiate(Ship, this.ShipThree, this.shipParent);
                        ship2.transform.position = this.lstPosShipSpawn.getItem(i).position.$clone();
                        ship2.Init(this.queueShip.getItem(i).typeColor);
                        if (i === 0) {
                            ship2.isReady = true;
                        }
                        this.lstShip.add(ship2);
                    }

                    count = (count + 1) | 0;
                }
                this.queueShip.removeAt(0);
                this.queueShip.removeAt(0);
            },
            /*Level.SpawnShipPredenfined end.*/

            /*Level.SpawnShipPredenfinedNext start.*/
            SpawnShipPredenfinedNext: function (index) {
if ( TRACE ) { TRACE( "Level#SpawnShipPredenfinedNext", this ); }

                if (this.lstShip.Count > 0) {
                    DG.Tweening.ShortcutExtensions.DOKill(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)));
                    DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMoveX(this.lstShip.getItem(0).transform, this.lstPosShipSpawn.getItem(0).position.x, 0.4), Bridge.fn.bind(this, function () {
                        this.lstShip.getItem(0).isReady = true;
                ...
                for (var i = 0; i < this.queueShip.Count; i = (i + 1) | 0) {
                    ...
                    if (this.queueShip.getItem(i).typeShip === TypeShip.One) {
                        var ship = UnityEngine.Object.Instantiate(Ship, this.ShipOne, this.shipParent);
                        ship.transform.position = new pc.Vec3( this.lstPosShipSpawn.getItem(i).position.x - 40, this.lstPosShipSpawn.getItem(i).position.y, this.lstPosShipSpawn.getItem(i).position.z );
                        ship.Init(this.queueShip.getItem(i).typeColor);
                        this.lstShip.add(ship);
                        DG.Tweening.ShortcutExtensions.DOKill(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)));
                        DG.Tweening.ShortcutExtensions.DOMoveX(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)).transform, this.lstPosShipSpawn.getItem(1).position.x, 0.3);
                    } else if (this.queueShip.getItem(i).typeShip === TypeShip.Two) {
                        var ship1 = UnityEngine.Object.Instantiate(Ship, this.ShipTwo, this.shipParent);
                        ship1.transform.position = new pc.Vec3( this.lstPosShipSpawn.getItem(i).position.x - 40, this.lstPosShipSpawn.getItem(i).position.y, this.lstPosShipSpawn.getItem(i).position.z );
                        ship1.Init(this.queueShip.getItem(i).typeColor);
                        this.lstShip.add(ship1);
                        DG.Tweening.ShortcutExtensions.DOKill(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)));
                        DG.Tweening.ShortcutExtensions.DOMoveX(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)).transform, this.lstPosShipSpawn.getItem(1).position.x, 0.3);
                        ...
                        var ship2 = UnityEngine.Object.Instantiate(Ship, this.ShipThree, this.shipParent);
                        ship2.transform.position = new pc.Vec3( this.lstPosShipSpawn.getItem(i).position.x, this.lstPosShipSpawn.getItem(i).position.y, this.lstPosShipSpawn.getItem(i).position.z );
                        ship2.Init(this.queueShip.getItem(i).typeColor);
                        this.lstShip.add(ship2);
                        DG.Tweening.ShortcutExtensions.DOKill(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)));
                        DG.Tweening.ShortcutExtensions.DOMoveX(this.lstShip.getItem(((this.lstShip.Count - 1) | 0)).transform, this.lstPosShipSpawn.getItem(1).position.x, 0.3);
                ...
                if (this.queueShip.Count > 0) {
                    this.queueShip.removeAt(0);
                }
            },
            /*Level.SpawnShipPredenfinedNext end.*/

            /*Level.UpdateCarParking start.*/
            UpdateCarParking: function () {
if ( TRACE ) { TRACE( "Level#UpdateCarParking", this ); }

                if (!this.NoParkingSlot()) {
                    for (var i = 0; i < this.lstParkingSlot.Count; i = (i + 1) | 0) {
                        if (UnityEngine.MonoBehaviour.op_Inequality(this.lstParkingSlot.getItem(i).car, null)) {
                            this.lstParkingSlot.getItem(i).car.ParkingSlotMoveToBox();
                        }
                    }
                }
            },
            /*Level.UpdateCarParking end.*/

            /*Level.UpdateParkingSlot start.*/
            UpdateParkingSlot: function (car) {
if ( TRACE ) { TRACE( "Level#UpdateParkingSlot", this ); }


                for (var i = 0; i < this.lstParkingSlot.Count; i = (i + 1) | 0) {
                    if (UnityEngine.MonoBehaviour.op_Equality(this.lstParkingSlot.getItem(i).car, null)) {
                        this.lstParkingSlot.getItem(i).car = car;
                        break;
                    }
                }

                if (this.NoParkingSlot()) {
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.Lose();
                }
            },
            /*Level.UpdateParkingSlot end.*/

            /*Level.GetParkingSlot start.*/
            GetParkingSlot: function () {
if ( TRACE ) { TRACE( "Level#GetParkingSlot", this ); }

                for (var i = 0; i < this.lstParkingSlot.Count; i = (i + 1) | 0) {
                    if (UnityEngine.MonoBehaviour.op_Equality(this.lstParkingSlot.getItem(i).car, null)) {
                        return this.lstParkingSlot.getItem(i);
                    }
                }

                return null;
            },
            /*Level.GetParkingSlot end.*/

            /*Level.NoParkingSlot start.*/
            NoParkingSlot: function () {
if ( TRACE ) { TRACE( "Level#NoParkingSlot", this ); }
            ...
            /*Level.NoParkingSlot end.*/

            /*Level.RemoveFromParkingSlot start.*/
            RemoveFromParkingSlot: function (car) {
if ( TRACE ) { TRACE( "Level#RemoveFromParkingSlot", this ); }

                for (var i = 0; i < this.lstParkingSlot.Count; i = (i + 1) | 0) {
                    if (UnityEngine.MonoBehaviour.op_Equality(this.lstParkingSlot.getItem(i).car, car)) {
                        this.lstParkingSlot.getItem(i).car = null;
                        return;
                    }
                }
            },
            /*Level.RemoveFromParkingSlot end.*/
...
if ( TRACE ) { TRACE( "NameTag#init", this ); }
    ...
    /*ObjectColor start.*/
    Bridge.define("ObjectColor", {
        fields: {
            typeColor: 0,
            material: null,
            materialGlasses: null,
            color: null
        },
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "ObjectColor#init", this ); }
    ...
    Bridge.define("QueueShip", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "QueueShip#init", this ); }

                this.typeShip = TypeShip.Three;
            }
        }
    });
    /*QueueShip end.*/
    ...
    Bridge.define("Responsive", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Responsive#init", this ); }

                this.oldScreenWidth = 0;
                this.oldScreenHeight = 0;
                this.isConvertScreen = false;
            }
        },
        methods: {
            /*Responsive.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "Responsive#Update", this ); }

                if (!Singleton$1(GlobalInstance).Instance.gameManagerInstance.isStartCheckFirstInteraction) {
                    if ((UnityEngine.Screen.width !== this.oldScreenWidth || UnityEngine.Screen.height !== this.oldScreenHeight) && !this.isConvertScreen) {
                        this.oldScreenWidth = UnityEngine.Screen.width;
                        this.oldScreenHeight = UnityEngine.Screen.height;
                        this.isConvertScreen = true;
                        this.Invoke("Respon", 0.05);
                    }
                }
            },
            /*Responsive.Update end.*/

            /*Responsive.Respon start.*/
            Respon: function () {
if ( TRACE ) { TRACE( "Responsive#Respon", this ); }

                var aspectRatio = (Bridge.Int.div(UnityEngine.Screen.width, UnityEngine.Screen.height)) | 0;
                if (aspectRatio >= 1) {
                    if (this.isConvertScreen) {
            ...
            /*Responsive.Respon end.*/

            /*Responsive.HandleLandscapeLayout start.*/
            HandleLandscapeLayout: function () {
if ( TRACE ) { TRACE( "Responsive#HandleLandscapeLayout", this ); }

                this.camera.orthographicSize = 5.5;
                this.isConvertScreen = false;
            },
            /*Responsive.HandleLandscapeLayout end.*/

            /*Responsive.HandlePortraitLayout start.*/
            HandlePortraitLayout: function () {
if ( TRACE ) { TRACE( "Responsive#HandlePortraitLayout", this ); }

                this.camera.orthographicSize = 12.0;
                this.isConvertScreen = false;
            },
            /*Responsive.HandlePortraitLayout end.*/
    ...
    Bridge.define("Ship", {
        ...
        ctors: {
            init: function () {
if ( TRACE ) { TRACE( "Ship#init", this ); }

                this.lstSlot = new (System.Collections.Generic.List$1(UnityEngine.Transform)).ctor();
                this.lstBooleanSlot = new (System.Collections.Generic.List$1(System.Boolean)).ctor();
                this.lstSlotFx = new (System.Collections.Generic.List$1(UnityEngine.ParticleSystem)).ctor();
                this.indexBox = 0;
            }
        },
        methods: {
            /*Ship.Init start.*/
            Init: function (typeColor) {
if ( TRACE ) { TRACE( "Ship#Init", this ); }

                this.typeColor = typeColor;
                var objectColor = Singleton$1(GlobalInstance).Instance.gameManagerInstance.config.GetObjectColor(this.typeColor);
                var mats = this.mainMesh.materials;
                mats[0] = objectColor.material; // Thay thế material đầu tiên
                this.mainMesh.materials = mats;
                for (var i = 0; i < this.lstSlot.Count; i = (i + 1) | 0) {
                    this.lstSlot.getItem(i).GetComponent(UnityEngine.MeshRenderer).material = objectColor.material;
                }
            },
            /*Ship.Init end.*/

            /*Ship.CheckPositive start.*/
            CheckPositive: function (typeColor) {
if ( TRACE ) { TRACE( "Ship#CheckPositive", this ); }

                if (typeColor === this.typeColor && this.isReady) {
                    return true;
                }

                return false;
            },
            /*Ship.CheckPositive end.*/

            /*Ship.UpdateShip start.*/
            UpdateShip: function () {
if ( TRACE ) { TRACE( "Ship#UpdateShip", this ); }

                if (!this.isDone) {
                    this.lstBooleanSlot.setItem(this.indexBox, true);
                    this.indexBox = (this.indexBox + 1) | 0;
                    if (this.indexBox > ((this.lstSlot.Count - 1) | 0)) {
                        this.isReady = false;
                        this.isDone = true;
                    }
                }
            ...
            /*Ship.CheckDone start.*/
            CheckDone: function () {
if ( TRACE ) { TRACE( "Ship#CheckDone", this ); }

                if (this.isDone) {
                    this.StartCoroutine$1(this.IEDelayHandelDone());
                }
            },
            /*Ship.CheckDone end.*/

            /*Ship.IEDelayHandelDone start.*/
            IEDelayHandelDone: function () {
if ( TRACE ) { TRACE( "Ship#IEDelayHandelDone", this ); }
                        ...
                        for (;;) {
                            switch ($step) {
                                ...
                                case 1: {
                                    //PlaySound
                                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.level.lstShip.remove(this);
                                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.level.SpawnShipPredenfinedNext(1);
                                        Singleton$1(AudioManager).Instance.PlaySoundShipMove();
                                        DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions), DG.Tweening.ShortcutExtensions.DOMoveX(this.transform, 23, 0.7), Bridge.fn.bind(this, function () {
                                            var $t;
                                            ($t = Singleton$1(GlobalInstance).Instance.gameManagerInstance.level).currentShip = ($t.currentShip + 1) | 0;
                                            if (Singleton$1(GlobalInstance).Instance.gameManagerInstance.level.currentShip === Singleton$1(GlobalInstance).Instance.gameManagerInstance.shipToWin) {
                                                Singleton$1(GlobalInstance).Instance.gameManagerInstance.Win();
                                            } else {
...
if ( TRACE ) { TRACE( "SimplePool#Spawn$3", this ); }
                    ...
                    return SimplePool._pools.getItem(prefab.GetInstanceID()).Spawn$1(pos, rot);
                },
...
if ( TRACE ) { TRACE( "SimplePool#Spawn$1", this ); }
                    ...
                    return SimplePool._pools.getItem(Bridge.rValue(prefab).gameObject.GetInstanceID()).Spawn(T, pos, rot);
                },
...
if ( TRACE ) { TRACE( "SimplePool.Pool#Spawn$1", this ); }
                ...
                while (true) {
                    ...
                    if (this._inactive.Count === 0) {
                        ...
                        // instantiate a whole new object.
                        obj = UnityEngine.Object.Instantiate$2(UnityEngine.GameObject, this._prefab, pos, rot);
                        obj.name = System.String.format("{0} ({1})", this._prefab.name, Bridge.box(Bridge.identity(this._nextId, ((this._nextId = (this._nextId + 1) | 0))), System.Int32));
...
if ( TRACE ) { TRACE( "SimplePool.Pool#Spawn", this ); }
                ...
                return this.Spawn$1(pos, rot).GetComponent(T);
            },
...
if ( TRACE ) { TRACE( "Stickman#Init", this ); }
            ...
            /*Stickman.Action start.*/
            Action: function () {
if ( TRACE ) { TRACE( "Stickman#Action", this ); }

                if (this.isCanMove) {
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.gamePlayController.isCanRaycast = false;
                    this.isCanMove = false;
                    this.Init();
                    this.isChoosed = true;
                    this.SetRumAnim(true);
                    DG.Tweening.TweenSettingsExtensions.OnUpdate(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.OnWaypointChange(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.SetSpeedBased$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.ShortcutExtensions.DOPath$1(this.transform, this.lstPointPath.ToArray(), this.speed, DG.Tweening.PathType.Linear, DG.Tweening.PathMode.Full3D), true), DG.Tweening.Ease.Linear), Bridge.fn.cacheBind(this, this.OnChangeWavePoint)), Bridge.fn.bind(this, function () {
...
if ( TRACE ) { TRACE( "Stickman#Comeback", this ); }
                ...
                DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.OnUpdate(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.OnWaypointChange(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.SetEase$2(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.TweenSettingsExtensions.SetSpeedBased$1(DG.Tweening.Core.TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions), DG.Tweening.ShortcutExtensions.DOPath$1(this.transform, this.lstPointReturnPath.ToArray(), this.speed, DG.Tweening.PathType.Linear, DG.Tweening.PathMode.Full3D), true), DG.Tweening.Ease.Linear), Bridge.fn.cacheBind(this, this.OnReturnPathChangePoint)), Bridge.fn.bind(this, function () {
                    ...
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.gamePlayController.isCanRaycast = true;
                    Singleton$1(GlobalInstance).Instance.gameManagerInstance.EndCinema();
                }));
            },
            /*Stickman.Comeback end.*/

            /*Stickman.OnChangeWavePoint start.*/
...
if ( TRACE ) { TRACE( "Stickman#GetNextPos", this ); }
                ...
                if (((this.lstCachePointPath.Count - 1) | 0) < i) {
                    return pc.Vec3.ZERO.clone();
                }
                return this.lstCachePointPath.getItem(((i + 1) | 0)).$clone();
            },
...
if ( TRACE ) { TRACE( "Stickman#GetNextReturnPathPos", this ); }
                ...
                if (((this.lstPointReturnPath.Count - 1) | 0) < i) {
                    return pc.Vec3.ZERO.clone();
                }
...
if ( TRACE ) { TRACE( "Stickman#OnTriggerEnter", this ); }
                ...
                if (other.CompareTag("StickMan")) {
                    if (this.isChoosed) {
                        ...
                        this.isCanMove = false;
                        this.SetRumAnim(false);
                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.SpawnVFXCrash(this.transform.position);
                        Singleton$1(GlobalInstance).Instance.gameManagerInstance.SpawnVFXFail(this.transform.position);
                        Singleton$1(AudioManager).Instance.PlaySoundImpact();
                        this.Comeback();
                    }
                }
                ...
                if (other.CompareTag("Car")) {
                    ...
                    if (car.typeColor !== this.typeColor) {
                        this.isChoosed = false;
                        DG.Tweening.ShortcutExtensions.DOKill(this.transform);
                        this.isCanMove = false;
                        this.SetRumAnim(false);
                        ...
                        if (car.id === this.id) {
                            ...
                            car.Action();
                            Singleton$1(GlobalInstance).Instance.gameManagerInstance.gamePlayController.isCanRaycast = true;
                            ($t = Singleton$1(GlobalInstance).Instance.gameManagerInstance.level).totalCar = ($t.totalCar - 1) | 0;
                            Singleton$1(AudioManager).Instance.PlaySoundCarExit();
            ...
            /*Stickman.OnTriggerEnter end.*/

            /*Stickman.SetRumAnim start.*/
            SetRumAnim: function ($boolean) {
if ( TRACE ) { TRACE( "Stickman#SetRumAnim", this ); }

                this.animator.SetBool$1("Run", $boolean);
            },
            /*Stickman.SetRumAnim end.*/
    ...
    Bridge.define("StickmanEC", {
        ...
        methods: {
            /*StickmanEC.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "StickmanEC#Start", this ); }
...
if ( TRACE ) { TRACE( "AudioManager#PlaySoundBG", this ); }
            ...
            /*AudioManager.PlaySoundClick start.*/
            PlaySoundClick: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundClick", this ); }

                this.PlaySoundFX(this.clipClick);
            },
            /*AudioManager.PlaySoundClick end.*/

            /*AudioManager.PlaySoundImpact start.*/
            PlaySoundImpact: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundImpact", this ); }

                this.PlaySoundFX(this.clipImpact);
            },
            /*AudioManager.PlaySoundImpact end.*/

            /*AudioManager.PlaySoundRun start.*/
            PlaySoundRun: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundRun", this ); }

                this.PlaySoundFX(this.clipRun);
            },
            /*AudioManager.PlaySoundRun end.*/

            /*AudioManager.PlaySoundCarExit start.*/
            PlaySoundCarExit: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundCarExit", this ); }

                this.PlaySoundFX(this.clipCarExit);
            },
            /*AudioManager.PlaySoundCarExit end.*/

            /*AudioManager.PlaySoundShipMove start.*/
            PlaySoundShipMove: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundShipMove", this ); }

                this.PlaySoundFX(this.clipShipMove);
            },
            /*AudioManager.PlaySoundShipMove end.*/

            /*AudioManager.PlaySoundClipLose start.*/
            PlaySoundClipLose: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundClipLose", this ); }

                this.PlaySoundFX(this.clipLose);
            },
            /*AudioManager.PlaySoundClipLose end.*/

            /*AudioManager.PlaySoundClipWin start.*/
            PlaySoundClipWin: function () {
if ( TRACE ) { TRACE( "AudioManager#PlaySoundClipWin", this ); }

                this.PlaySoundFX(this.clipWin);
            },
            /*AudioManager.PlaySoundClipWin end.*/
...
if ( TRACE ) { TRACE( "GlobalInstance#init", this ); }
                ...
                this.gameManagerInstance = Singleton$1(PLY01Manager).Instance;
            }
        }
    });
    /*GlobalInstance end.*/
    ...
    /*PLY01Manager start.*/
    Bridge.define("PLY01Manager", {
        inherits: function () {
if ( TRACE ) { TRACE( "PLY01Manager#inherits", this ); }
 return [Singleton$1(PLY01Manager)]; },
        fields: {
            ...
            isStartCheckFirstInteraction: false,
        ...
        methods: {
            /*PLY01Manager.Start start.*/
            Start: function () {
if ( TRACE ) { TRACE( "PLY01Manager#Start", this ); }

                Luna.Unity.LifeCycle.GameStarted();
                this.level.Init();
                this.isFirstTutCinema = true;
                this.isFirstInteraction = true;
                this.isFirstEndCinema = true;
                this.currentTime = this.totalTime;
                this.cameraController.Init();
            },
            /*PLY01Manager.Start end.*/

            /*PLY01Manager.FirstTutCinema start.*/
            FirstTutCinema: function () {
if ( TRACE ) { TRACE( "PLY01Manager#FirstTutCinema", this ); }

                if (this.isFirstTutCinema) {
                    this.isFirstTutCinema = false;
                    DG.Tweening.DOTweenModuleUI.DOFade$2(this.tut0.GetComponent(UnityEngine.UI.Image), 0, 0.15);
                    DG.Tweening.DOTweenModuleSprite.DOFade(this.tutHand0.GetComponent(UnityEngine.SpriteRenderer), 0, 0.15);
                }
            },
            /*PLY01Manager.FirstTutCinema end.*/

            /*PLY01Manager.EndCinema start.*/
            EndCinema: function () {
if ( TRACE ) { TRACE( "PLY01Manager#EndCinema", this ); }

                if (this.isFirstEndCinema) {
                    this.isCanPlay = false;
                    this.cameraController.SetFollow(false);
                    this.isFirstEndCinema = false;
                    this.camera.transform.SetParent(null);
                    DG.Tweening.TweenSettingsExtensions.OnComplete(DG.Tweening.Core.TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions), DG.Tweening.ShortcutExtensions.DOOrthoSize(this.camera, 25, 1.0), Bridge.fn.bind(this, function () {
                        DG.Tweening.DOTweenModuleUI.DOFade$2(this.tut.GetComponent(UnityEngine.UI.Image), 1, 0.3);
                        DG.Tweening.DOTweenModuleSprite.DOFade(this.tutHand.GetComponent(UnityEngine.SpriteRenderer), 1, 0.3);
                        this.isStartCheckFirstInteraction = true;
                        this.isCanPlay = true;
                    }));
                    DG.Tweening.ShortcutExtensions.DOMove(this.camera.transform, new pc.Vec3( 0, 84.4, -50 ), 1.0);
                }
            },
            /*PLY01Manager.EndCinema end.*/

            /*PLY01Manager.FirstInteraction start.*/
            FirstInteraction: function () {
if ( TRACE ) { TRACE( "PLY01Manager#FirstInteraction", this ); }

                if (this.isStartCheckFirstInteraction) {
                    if (this.isFirstInteraction) {
                        this.isFirstInteraction = false;
                        this.isPlaying = true;
                        DG.Tweening.DOTweenModuleUI.DOFade$2(this.tut.GetComponent(UnityEngine.UI.Image), 0, 0.15);
                        DG.Tweening.DOTweenModuleSprite.DOFade(this.tutHand.GetComponent(UnityEngine.SpriteRenderer), 0, 0.15);

                    }
                }
            },
            /*PLY01Manager.FirstInteraction end.*/

            /*PLY01Manager.Update start.*/
            Update: function () {
if ( TRACE ) { TRACE( "PLY01Manager#Update", this ); }

                if (this.isPlaying) {
                    if (this.currentTime > 0) {
                        this.currentTime -= 1 * UnityEngine.Time.deltaTime;
                        if (this.currentTime < 9.5) {
                            this.txtTime.text = "00:0" + (System.Single.format(this.currentTime, "0") || "");
                        } else {
                            this.txtTime.text = "00:" + (System.Single.format(this.currentTime, "0") || "");
                        }
                    } else {
                        if (!this.isLose) {
                            this.currentTime = 0;
            ...
            /*PLY01Manager.Update end.*/

            /*PLY01Manager.UpdateTap start.*/
            UpdateTap: function () {
if ( TRACE ) { TRACE( "PLY01Manager#UpdateTap", this ); }

                if (this.isStartCheckFirstInteraction) {
                    this.currentTap = (this.currentTap + 1) | 0;
                    this.txtTap.text = this.currentTap + "/10";
                    if (this.currentTap === this.totalTap) {
                        if (!this.isWin && !this.isLose && this.level.totalCar > 1) {
                            this.Lose();
                        }
                    }
                }
            },
            /*PLY01Manager.UpdateTap end.*/

            /*PLY01Manager.SpawnVFXCrash start.*/
            SpawnVFXCrash: function (pos) {
if ( TRACE ) { TRACE( "PLY01Manager#SpawnVFXCrash", this ); }

                var vfx = SimplePool.Spawn$2(this.vfxCrash);
                var newPos = new pc.Vec3( pos.x, pos.y + 1.0, pos.z );
                vfx.transform.position = newPos.$clone();
            },
            /*PLY01Manager.SpawnVFXCrash end.*/

            /*PLY01Manager.SpawnVFXFail start.*/
            SpawnVFXFail: function (pos) {
if ( TRACE ) { TRACE( "PLY01Manager#SpawnVFXFail", this ); }

                var vfx = SimplePool.Spawn$2(this.vfxFail);
                var newPos = new pc.Vec3( pos.x, 3, pos.z );
                vfx.transform.position = newPos.$clone();
                vfx.transform.rotation = new pc.Quat().setFromEulerAngles_Unity( 60, 0, 0 );
            },
            /*PLY01Manager.SpawnVFXFail end.*/

            /*PLY01Manager.Win start.*/
            Win: function () {
if ( TRACE ) { TRACE( "PLY01Manager#Win", this ); }

                if (!this.isLose && !this.isWin) {
                    Singleton$1(AudioManager).Instance.PlaySoundClipWin();
                    Luna.Unity.LifeCycle.GameEnded();
                    this.isWin = true;
            ...
            /*PLY01Manager.Win end.*/

            /*PLY01Manager.Lose start.*/
            Lose: function () {
if ( TRACE ) { TRACE( "PLY01Manager#Lose", this ); }
            ...
            /*PLY01Manager.Lose end.*/

            /*PLY01Manager.InstallFullGame start.*/
            InstallFullGame: function () {
if ( TRACE ) { TRACE( "PLY01Manager#InstallFullGame", this ); }

                Luna.Unity.Playable.InstallFullGame();
            },
            /*PLY01Manager.InstallFullGame end.*/
...
if ( TRACE ) { TRACE( "SingletonDontDestroyOnLoad$1#Awake", this ); }
    ...
    var $m = Bridge.setMetadata,
        $n = ["System","UnityEngine","System.Collections.Generic","System.Collections","UnityEngine.UI","UnityEngine.Audio","DG.Tweening.Core","DG.Tweening","DG.Tweening.Plugins.Core.PathCore","System.Globalization","DG.Tweening.Plugins.Options"];

    /*CameraController start.*/
    $m("CameraController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"FollowTarget","t":8,"sn":"FollowTarget","rt":$n[0].Void},{"a":2,"n":"Init","t":8,"sn":"Init","rt":$n[0].Void},{"a":1,"n":"LateUpdate","t":8,"sn":"LateUpdate","rt":$n[0].Void},{"a":2,"n":"SetFollow","t":8,"pi":[{"n":"isFollow","pt":$n[0].Boolean,"ps":0}],"sn":"SetFollow","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":1,"n":"distance","t":4,"rt":$n[0].Single,"sn":"distance","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"isFollowing","t":4,"rt":$n[0].Boolean,"sn":"isFollowing","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"newPositionOffset","t":4,"rt":$n[1].Vector3,"sn":"newPositionOffset"},{"a":1,"n":"offset","t":4,"rt":$n[1].Vector3,"sn":"offset"},{"a":1,"n":"positionOffsetIngame","t":4,"rt":$n[1].Vector3,"sn":"positionOffsetIngame"},{"a":2,"n":"target","t":4,"rt":$n[1].Transform,"sn":"target"},{"a":1,"n":"velocity","t":4,"rt":$n[1].Vector3,"sn":"velocity"}]}; }, $n);
    /*CameraController end.*/

    /*Car start.*/
    $m("Car", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Action","t":8,"sn":"Action","rt":$n[0].Void},{"a":1,"n":"CheckPositiveAndMoveToShip","t":8,"sn":"CheckPositiveAndMoveToShip","rt":$n[0].Void},{"a":1,"n":"MoveToParkingSlot","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0}],"sn":"MoveToParkingSlot","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":2,"n":"MoveToShip","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0},{"n":"ship","pt":Ship,"ps":1},{"n":"indexCarInShip","pt":$n[0].Int32,"ps":2},{"n":"isHasDelay","pt":$n[0].Boolean,"ps":3}],"sn":"MoveToShip","rt":$n[0].Void,"p":[$n[1].Vector3,Ship,$n[0].Int32,$n[0].Boolean]},{"a":2,"n":"ParkingSlotMoveToBox","t":8,"sn":"ParkingSlotMoveToBox","rt":$n[0].Void},{"a":2,"n":"boxCollider","t":4,"rt":$n[1].BoxCollider,"sn":"boxCollider"},{"a":1,"n":"delay","t":4,"rt":$n[0].Single,"sn":"delay","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"id","t":4,"rt":$n[0].Int32,"sn":"id","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"isCarInParking","t":4,"rt":$n[0].Boolean,"sn":"isCarInParking","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isMoving","t":4,"rt":$n[0].Boolean,"sn":"isMoving","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"speed","t":4,"rt":$n[0].Single,"sn":"speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"typeColor","t":4,"rt":TypeColor,"sn":"typeColor","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"vfxCollect","t":4,"rt":$n[1].GameObject,"sn":"vfxCollect"}]}; }, $n);
    /*Car end.*/

    /*Config start.*/
    $m("Config", function () { return {"att":1048577,"a":2,"at":[Bridge.apply(new UnityEngine.CreateAssetMenuAttribute(), {
        fileName: "GameConfig", menuName: "DataConfig/GameConfig"
    } )],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"GetObjectColor","t":8,"pi":[{"n":"typeColor","pt":TypeColor,"ps":0}],"sn":"GetObjectColor","rt":ObjectColor,"p":[TypeColor]},{"a":2,"n":"lstObjectColor","t":4,"rt":$n[2].List$1(ObjectColor),"sn":"lstObjectColor"}]}; }, $n);
    /*Config end.*/

    /*ObjectColor start.*/
    $m("ObjectColor", function () { return {"att":1056769,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"color","t":4,"rt":$n[1].Color,"sn":"color"},{"a":2,"n":"material","t":4,"rt":$n[1].Material,"sn":"material"},{"a":2,"n":"materialGlasses","t":4,"rt":$n[1].Material,"sn":"materialGlasses"},{"a":2,"n":"typeColor","t":4,"rt":TypeColor,"sn":"typeColor","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}}]}; }, $n);
    /*ObjectColor end.*/

    /*GamePlayController start.*/
    $m("GamePlayController", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"Touch","t":8,"sn":"Touch","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"camera","t":4,"rt":$n[1].Camera,"sn":"camera"},{"a":2,"n":"fxTap","t":4,"rt":$n[1].ParticleSystem,"sn":"fxTap"},{"a":1,"n":"hit","t":4,"rt":$n[1].RaycastHit,"sn":"hit"},{"a":2,"n":"isCanRaycast","t":4,"rt":$n[0].Boolean,"sn":"isCanRaycast","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"ray","t":4,"rt":$n[1].Ray,"sn":"ray"}]}; }, $n);
    /*GamePlayController end.*/

    /*Level start.*/
    $m("Level", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"GetParkingSlot","t":8,"sn":"GetParkingSlot","rt":ParkingSlot},{"a":2,"n":"Init","t":8,"sn":"Init","rt":$n[0].Void},{"a":2,"n":"NoParkingSlot","t":8,"sn":"NoParkingSlot","rt":$n[0].Boolean,"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"RemoveFromParkingSlot","t":8,"pi":[{"n":"car","pt":Car,"ps":0}],"sn":"RemoveFromParkingSlot","rt":$n[0].Void,"p":[Car]},{"a":2,"n":"SpawnShipPredenfined","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"SpawnShipPredenfined","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":2,"n":"SpawnShipPredenfinedNext","t":8,"pi":[{"n":"index","pt":$n[0].Int32,"ps":0}],"sn":"SpawnShipPredenfinedNext","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"UpdateCarParking","t":8,"sn":"UpdateCarParking","rt":$n[0].Void},{"a":2,"n":"UpdateParkingSlot","t":8,"pi":[{"n":"car","pt":Car,"ps":0}],"sn":"UpdateParkingSlot","rt":$n[0].Void,"p":[Car]},{"a":2,"n":"ShipOne","t":4,"rt":Ship,"sn":"ShipOne"},{"a":2,"n":"ShipThree","t":4,"rt":Ship,"sn":"ShipThree"},{"a":2,"n":"ShipTwo","t":4,"rt":Ship,"sn":"ShipTwo"},{"a":2,"n":"currentShip","t":4,"rt":$n[0].Int32,"sn":"currentShip","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"grParkingSlot","t":4,"rt":$n[1].Transform,"sn":"grParkingSlot"},{"a":2,"n":"lstCouple","t":4,"rt":$n[2].List$1(UnityEngine.GameObject),"sn":"lstCouple"},{"a":2,"n":"lstParkingSlot","t":4,"rt":$n[2].List$1(ParkingSlot),"sn":"lstParkingSlot"},{"a":2,"n":"lstPosShipSpawn","t":4,"rt":$n[2].List$1(UnityEngine.Transform),"sn":"lstPosShipSpawn"},{"a":2,"n":"lstShip","t":4,"rt":$n[2].List$1(Ship),"sn":"lstShip"},{"a":2,"n":"queueShip","t":4,"rt":$n[2].List$1(QueueShip),"sn":"queueShip"},{"a":2,"n":"shipParent","t":4,"rt":$n[1].Transform,"sn":"shipParent"},{"a":2,"n":"totalCar","t":4,"rt":$n[0].Int32,"sn":"totalCar","box":function ($v) { return Bridge.box($v, System.Int32);}}]}; }, $n);
    /*Level end.*/

    /*ParkingSlot start.*/
    $m("ParkingSlot", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"car","t":4,"rt":Car,"sn":"car"}]}; }, $n);
    /*ParkingSlot end.*/

    /*Responsive start.*/
    $m("Responsive", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":1,"n":"HandleLandscapeLayout","t":8,"sn":"HandleLandscapeLayout","rt":$n[0].Void},{"a":1,"n":"HandlePortraitLayout","t":8,"sn":"HandlePortraitLayout","rt":$n[0].Void},{"a":1,"n":"Respon","t":8,"sn":"Respon","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"camera","t":4,"rt":$n[1].Camera,"sn":"camera"},{"a":1,"n":"isConvertScreen","t":4,"rt":$n[0].Boolean,"sn":"isConvertScreen","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"oldScreenHeight","t":4,"rt":$n[0].Single,"sn":"oldScreenHeight","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":1,"n":"oldScreenWidth","t":4,"rt":$n[0].Single,"sn":"oldScreenWidth","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}}]}; }, $n);
    /*Responsive end.*/

    /*QueueShip start.*/
    $m("QueueShip", function () { return {"att":1056769,"a":2,"at":[new System.SerializableAttribute()],"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"typeColor","t":4,"rt":TypeColor,"sn":"typeColor","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"typeShip","t":4,"rt":TypeShip,"sn":"typeShip","box":function ($v) { return Bridge.box($v, TypeShip, System.Enum.toStringFn(TypeShip));}}]}; }, $n);
    /*QueueShip end.*/

    /*TypeShip start.*/
    $m("TypeShip", function () { return {"att":257,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"One","is":true,"t":4,"rt":TypeShip,"sn":"One","box":function ($v) { return Bridge.box($v, TypeShip, System.Enum.toStringFn(TypeShip));}},{"a":2,"n":"Three","is":true,"t":4,"rt":TypeShip,"sn":"Three","box":function ($v) { return Bridge.box($v, TypeShip, System.Enum.toStringFn(TypeShip));}},{"a":2,"n":"Two","is":true,"t":4,"rt":TypeShip,"sn":"Two","box":function ($v) { return Bridge.box($v, TypeShip, System.Enum.toStringFn(TypeShip));}}]}; }, $n);
    /*TypeShip end.*/

    /*Ship start.*/
    $m("Ship", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"CheckDone","t":8,"sn":"CheckDone","rt":$n[0].Void},{"a":2,"n":"CheckPositive","t":8,"pi":[{"n":"typeColor","pt":TypeColor,"ps":0}],"sn":"CheckPositive","rt":$n[0].Boolean,"p":[TypeColor],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"IEDelayHandelDone","t":8,"sn":"IEDelayHandelDone","rt":$n[3].IEnumerator},{"a":2,"n":"Init","t":8,"pi":[{"n":"typeColor","pt":TypeColor,"ps":0}],"sn":"Init","rt":$n[0].Void,"p":[TypeColor]},{"a":2,"n":"UpdateShip","t":8,"sn":"UpdateShip","rt":$n[0].Void},{"a":2,"n":"animator","t":4,"rt":$n[1].Animator,"sn":"animator"},{"a":2,"n":"containCar","t":4,"rt":$n[1].Transform,"sn":"containCar"},{"a":2,"n":"indexBox","t":4,"rt":$n[0].Int32,"sn":"indexBox","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"isDone","t":4,"rt":$n[0].Boolean,"sn":"isDone","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"at":[new UnityEngine.HeaderAttribute("Dont Touch")],"a":2,"n":"isReady","t":4,"rt":$n[0].Boolean,"sn":"isReady","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lstBooleanSlot","t":4,"rt":$n[2].List$1(System.Boolean),"sn":"lstBooleanSlot"},{"a":2,"n":"lstSlot","t":4,"rt":$n[2].List$1(UnityEngine.Transform),"sn":"lstSlot"},{"a":2,"n":"lstSlotFx","t":4,"rt":$n[2].List$1(UnityEngine.ParticleSystem),"sn":"lstSlotFx"},{"a":2,"n":"mainMesh","t":4,"rt":$n[1].MeshRenderer,"sn":"mainMesh"},{"a":2,"n":"typeColor","t":4,"rt":TypeColor,"sn":"typeColor","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}}]}; }, $n);
    /*Ship end.*/

    /*Stickman start.*/
    $m("Stickman", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Action","t":8,"sn":"Action","rt":$n[0].Void},{"a":1,"n":"Comeback","t":8,"sn":"Comeback","rt":$n[0].Void},{"a":1,"n":"GetNextPos","t":8,"pi":[{"n":"i","pt":$n[0].Int32,"ps":0}],"sn":"GetNextPos","rt":$n[1].Vector3,"p":[$n[0].Int32]},{"a":1,"n":"GetNextReturnPathPos","t":8,"pi":[{"n":"i","pt":$n[0].Int32,"ps":0}],"sn":"GetNextReturnPathPos","rt":$n[1].Vector3,"p":[$n[0].Int32]},{"a":2,"n":"Init","t":8,"sn":"Init","rt":$n[0].Void},{"a":1,"n":"OnChangeWavePoint","t":8,"pi":[{"n":"i","pt":$n[0].Int32,"ps":0}],"sn":"OnChangeWavePoint","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"OnReturnPathChangePoint","t":8,"pi":[{"n":"i","pt":$n[0].Int32,"ps":0}],"sn":"OnReturnPathChangePoint","rt":$n[0].Void,"p":[$n[0].Int32]},{"a":1,"n":"OnTriggerEnter","t":8,"pi":[{"n":"other","pt":$n[1].Collider,"ps":0}],"sn":"OnTriggerEnter","rt":$n[0].Void,"p":[$n[1].Collider]},{"a":2,"n":"SetRumAnim","t":8,"pi":[{"n":"boolean","pt":$n[0].Boolean,"ps":0}],"sn":"SetRumAnim","rt":$n[0].Void,"p":[$n[0].Boolean]},{"a":2,"n":"animator","t":4,"rt":$n[1].Animator,"sn":"animator"},{"a":2,"n":"arrayLinePoint","t":4,"rt":$n[1].Transform,"sn":"arrayLinePoint"},{"a":1,"n":"curLineCount","t":4,"rt":$n[0].Int32,"sn":"curLineCount","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"id","t":4,"rt":$n[0].Int32,"sn":"id","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"isCanMove","t":4,"rt":$n[0].Boolean,"sn":"isCanMove","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isChoosed","t":4,"rt":$n[0].Boolean,"sn":"isChoosed","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"lineRenderer","t":4,"rt":$n[1].LineRenderer,"sn":"lineRenderer"},{"a":1,"n":"lstCachePointPath","t":4,"rt":$n[2].List$1(UnityEngine.Vector3),"sn":"lstCachePointPath"},{"a":1,"n":"lstPointLineReturn","t":4,"rt":$n[2].List$1(UnityEngine.Vector3),"sn":"lstPointLineReturn"},{"a":1,"n":"lstPointPath","t":4,"rt":$n[2].List$1(UnityEngine.Vector3),"sn":"lstPointPath"},{"a":1,"n":"lstPointReturnPath","t":4,"rt":$n[2].List$1(UnityEngine.Vector3),"sn":"lstPointReturnPath"},{"a":1,"n":"originRotation","t":4,"rt":$n[1].Vector3,"sn":"originRotation"},{"a":2,"n":"speed","t":4,"rt":$n[0].Single,"sn":"speed","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"timeRotate","t":4,"rt":$n[0].Single,"sn":"timeRotate","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"typeColor","t":4,"rt":TypeColor,"sn":"typeColor","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}}]}; }, $n);
    /*Stickman end.*/

    /*StickmanEC start.*/
    $m("StickmanEC", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":2,"n":"arrayLinePoint","t":4,"rt":$n[1].Transform,"sn":"arrayLinePoint"},{"a":2,"n":"lineRenderer","t":4,"rt":$n[1].LineRenderer,"sn":"lineRenderer"}]}; }, $n);
    /*StickmanEC end.*/

    /*EC01 start.*/
    $m("EC01", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void}]}; }, $n);
    /*EC01 end.*/

    /*PLY01Manager start.*/
    $m("PLY01Manager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"EndCinema","t":8,"sn":"EndCinema","rt":$n[0].Void},{"a":2,"n":"FirstInteraction","t":8,"sn":"FirstInteraction","rt":$n[0].Void},{"a":2,"n":"FirstTutCinema","t":8,"sn":"FirstTutCinema","rt":$n[0].Void},{"a":2,"n":"InstallFullGame","t":8,"sn":"InstallFullGame","rt":$n[0].Void},{"a":2,"n":"Lose","t":8,"sn":"Lose","rt":$n[0].Void},{"a":2,"n":"SpawnVFXCrash","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0}],"sn":"SpawnVFXCrash","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":2,"n":"SpawnVFXFail","t":8,"pi":[{"n":"pos","pt":$n[1].Vector3,"ps":0}],"sn":"SpawnVFXFail","rt":$n[0].Void,"p":[$n[1].Vector3]},{"a":1,"n":"Start","t":8,"sn":"Start","rt":$n[0].Void},{"a":1,"n":"Update","t":8,"sn":"Update","rt":$n[0].Void},{"a":2,"n":"UpdateTap","t":8,"sn":"UpdateTap","rt":$n[0].Void},{"a":2,"n":"Win","t":8,"sn":"Win","rt":$n[0].Void},{"a":2,"n":"camera","t":4,"rt":$n[1].Camera,"sn":"camera"},{"a":2,"n":"cameraController","t":4,"rt":CameraController,"sn":"cameraController"},{"a":2,"n":"config","t":4,"rt":Config,"sn":"config"},{"a":1,"n":"currentTap","t":4,"rt":$n[0].Int32,"sn":"currentTap","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":1,"n":"currentTime","t":4,"rt":$n[0].Single,"sn":"currentTime","box":function ($v) { return Bridge.box($v, System.Single, System.Single.format, System.Single.getHashCode);}},{"a":2,"n":"gamePlayController","t":4,"rt":GamePlayController,"sn":"gamePlayController"},{"a":2,"n":"isCanPlay","t":4,"rt":$n[0].Boolean,"sn":"isCanPlay","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isEndGame","t":4,"rt":$n[0].Boolean,"sn":"isEndGame","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isFirstEndCinema","t":4,"rt":$n[0].Boolean,"sn":"isFirstEndCinema","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isFirstInteraction","t":4,"rt":$n[0].Boolean,"sn":"isFirstInteraction","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isFirstTutCinema","t":4,"rt":$n[0].Boolean,"sn":"isFirstTutCinema","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isLose","t":4,"rt":$n[0].Boolean,"sn":"isLose","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isPlaying","t":4,"rt":$n[0].Boolean,"sn":"isPlaying","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"isStartCheckFirstInteraction","t":4,"rt":$n[0].Boolean,"sn":"isStartCheckFirstInteraction","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":1,"n":"isWin","t":4,"rt":$n[0].Boolean,"sn":"isWin","box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"level","t":4,"rt":Level,"sn":"level"},{"a":2,"n":"lose","t":4,"rt":$n[1].GameObject,"sn":"lose"},{"a":2,"n":"shipToWin","t":4,"rt":$n[0].Int32,"sn":"shipToWin","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"totalTap","t":4,"rt":$n[0].Int32,"sn":"totalTap","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"totalTime","t":4,"rt":$n[0].Int32,"sn":"totalTime","box":function ($v) { return Bridge.box($v, System.Int32);}},{"a":2,"n":"tut","t":4,"rt":$n[1].GameObject,"sn":"tut"},{"a":2,"n":"tut0","t":4,"rt":$n[1].GameObject,"sn":"tut0"},{"a":2,"n":"tutHand","t":4,"rt":$n[1].GameObject,"sn":"tutHand"},{"a":2,"n":"tutHand0","t":4,"rt":$n[1].GameObject,"sn":"tutHand0"},{"a":2,"n":"txtTap","t":4,"rt":$n[4].Text,"sn":"txtTap"},{"a":2,"n":"txtTime","t":4,"rt":$n[4].Text,"sn":"txtTime"},{"a":2,"n":"vfxCrash","t":4,"rt":$n[1].GameObject,"sn":"vfxCrash"},{"a":2,"n":"vfxFail","t":4,"rt":$n[1].GameObject,"sn":"vfxFail"},{"a":2,"n":"win","t":4,"rt":$n[1].GameObject,"sn":"win"}]}; }, $n);
    /*PLY01Manager end.*/

    /*AudioManager start.*/
    $m("AudioManager", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"PlaySound","t":8,"sn":"PlaySound","rt":$n[0].Void},{"a":2,"n":"PlaySoundBG","t":8,"sn":"PlaySoundBG","rt":$n[0].Void},{"a":2,"n":"PlaySoundCarExit","t":8,"sn":"PlaySoundCarExit","rt":$n[0].Void},{"a":2,"n":"PlaySoundClick","t":8,"sn":"PlaySoundClick","rt":$n[0].Void},{"a":2,"n":"PlaySoundClipLose","t":8,"sn":"PlaySoundClipLose","rt":$n[0].Void},{"a":2,"n":"PlaySoundClipWin","t":8,"sn":"PlaySoundClipWin","rt":$n[0].Void},{"a":1,"n":"PlaySoundFX","t":8,"pi":[{"n":"audioClip","pt":$n[1].AudioClip,"ps":0}],"sn":"PlaySoundFX","rt":$n[0].Void,"p":[$n[1].AudioClip]},{"a":2,"n":"PlaySoundImpact","t":8,"sn":"PlaySoundImpact","rt":$n[0].Void},{"a":2,"n":"PlaySoundRun","t":8,"sn":"PlaySoundRun","rt":$n[0].Void},{"a":2,"n":"PlaySoundShipMove","t":8,"sn":"PlaySoundShipMove","rt":$n[0].Void},{"a":2,"n":"StopSound","t":8,"sn":"StopSound","rt":$n[0].Void},{"a":2,"n":"audioSourceBG","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceBG"},{"a":2,"n":"audioSourceFX","t":4,"rt":$n[1].AudioSource,"sn":"audioSourceFX"},{"a":2,"n":"clipCarExit","t":4,"rt":$n[1].AudioClip,"sn":"clipCarExit"},{"a":2,"n":"clipClick","t":4,"rt":$n[1].AudioClip,"sn":"clipClick"},{"a":2,"n":"clipImpact","t":4,"rt":$n[1].AudioClip,"sn":"clipImpact"},{"a":2,"n":"clipLose","t":4,"rt":$n[1].AudioClip,"sn":"clipLose"},{"a":2,"n":"clipRun","t":4,"rt":$n[1].AudioClip,"sn":"clipRun"},{"a":2,"n":"clipShipMove","t":4,"rt":$n[1].AudioClip,"sn":"clipShipMove"},{"a":2,"n":"clipWin","t":4,"rt":$n[1].AudioClip,"sn":"clipWin"}]}; }, $n);
    /*AudioManager end.*/
    ...
    /*EventID start.*/
    $m("EventID", function () { return {"att":257,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"RemoveBoomInList","is":true,"t":4,"rt":EventID,"sn":"RemoveBoomInList","box":function ($v) { return Bridge.box($v, EventID, System.Enum.toStringFn(EventID));}}]}; }, $n);
    /*EventID end.*/

    /*TypeColor start.*/
    $m("TypeColor", function () { return {"att":257,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"Blue","is":true,"t":4,"rt":TypeColor,"sn":"Blue","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"Green","is":true,"t":4,"rt":TypeColor,"sn":"Green","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"Orange","is":true,"t":4,"rt":TypeColor,"sn":"Orange","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"Red","is":true,"t":4,"rt":TypeColor,"sn":"Red","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}},{"a":2,"n":"Yellow","is":true,"t":4,"rt":TypeColor,"sn":"Yellow","box":function ($v) { return Bridge.box($v, TypeColor, System.Enum.toStringFn(TypeColor));}}]}; }, $n);
    /*TypeColor end.*/

    /*GameState start.*/
    $m("GameState", function () { return {"att":257,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"END_GAME","is":true,"t":4,"rt":GameState,"sn":"END_GAME","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}},{"a":2,"n":"IN_GAME","is":true,"t":4,"rt":GameState,"sn":"IN_GAME","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}},{"a":2,"n":"LOBBY","is":true,"t":4,"rt":GameState,"sn":"LOBBY","box":function ($v) { return Bridge.box($v, GameState, System.Enum.toStringFn(GameState));}}]}; }, $n);
    /*GameState end.*/
    ...
    /*GlobalInstance start.*/
    $m("GlobalInstance", function () { return {"att":1048577,"a":2,"m":[{"a":2,"isSynthetic":true,"n":".ctor","t":1,"sn":"ctor"},{"a":2,"n":"gameManagerInstance","t":4,"rt":PLY01Manager,"sn":"gameManagerInstance"}]}; }, $n);
    /*GlobalInstance end.*/
    ...
    /*DG.Tweening.DOTweenModulePhysics start.*/
    $m("DG.Tweening.DOTweenModulePhysics", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[1].Vector3,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[7].Sequence,"p":[$n[1].Rigidbody,$n[1].Vector3,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"path","pt":$n[8].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody,$n[8].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOLookAt","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"towards","pt":$n[1].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"axisConstraint","dv":0,"o":true,"pt":$n[7].AxisConstraint,"ps":3},{"n":"up","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Vector3),"ps":4}],"sn":"DOLookAt","rt":$n[6].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[1].Rigidbody,$n[1].Vector3,$n[0].Single,$n[7].AxisConstraint,$n[0].Nullable$1(UnityEngine.Vector3)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[1].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody,$n[1].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveZ","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"path","pt":$n[8].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody,$n[8].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector3),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody,System.Array.type(UnityEngine.Vector3),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody,"ps":0},{"n":"endValue","pt":$n[1].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"mode","dv":0,"o":true,"pt":$n[7].RotateMode,"ps":3}],"sn":"DORotate","rt":$n[6].TweenerCore$3(UnityEngine.Quaternion,UnityEngine.Vector3,DG.Tweening.Plugins.Options.QuaternionOptions),"p":[$n[1].Rigidbody,$n[1].Vector3,$n[0].Single,$n[7].RotateMode]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics end.*/

    /*DG.Tweening.DOTweenModulePhysics2D start.*/
    $m("DG.Tweening.DOTweenModulePhysics2D", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOJump","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJump","rt":$n[7].Sequence,"p":[$n[1].Rigidbody2D,$n[1].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":$n[8].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOLocalPath$1","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,$n[8].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOLocalPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOLocalPath","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DOMove","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMove","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveX","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMoveY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMoveY","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":4,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":$n[8].Path,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":3}],"sn":"DOPath$1","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,$n[8].Path,$n[0].Single,$n[7].PathMode]},{"a":2,"n":"DOPath","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"path","pt":System.Array.type(UnityEngine.Vector2),"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"pathType","dv":0,"o":true,"pt":$n[7].PathType,"ps":3},{"n":"pathMode","dv":1,"o":true,"pt":$n[7].PathMode,"ps":4},{"n":"resolution","dv":10,"o":true,"pt":$n[0].Int32,"ps":5},{"n":"gizmoColor","dv":null,"o":true,"pt":$n[0].Nullable$1(UnityEngine.Color),"ps":6}],"sn":"DOPath","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].Rigidbody2D,System.Array.type(UnityEngine.Vector2),$n[0].Single,$n[7].PathType,$n[7].PathMode,$n[0].Int32,$n[0].Nullable$1(UnityEngine.Color)]},{"a":2,"n":"DORotate","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Rigidbody2D,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DORotate","rt":$n[6].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[1].Rigidbody2D,$n[0].Single,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModulePhysics2D end.*/

    /*DG.Tweening.DOTweenModuleSprite start.*/
    $m("DG.Tweening.DOTweenModuleSprite", function () { return {"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[7].Tweener,"p":[$n[1].SpriteRenderer,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[1].SpriteRenderer,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].SpriteRenderer,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[1].SpriteRenderer,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].SpriteRenderer,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[7].Sequence,"p":[$n[1].SpriteRenderer,pc.ColorGradient,$n[0].Single]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleSprite end.*/

    /*DG.Tweening.DOTweenModuleUI start.*/
    $m("DG.Tweening.DOTweenModuleUI", function () { return {"nested":[$n[7].DOTweenModuleUI.Utils],"att":1048961,"a":2,"s":true,"m":[{"a":2,"n":"DOAnchorMax","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMax","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorMin","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorMin","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3D","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector3,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3D","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector3,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DX","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DY","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPos3DZ","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPos3DZ","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,UnityEngine.Vector3,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosX","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOAnchorPosY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOAnchorPosY","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor","rt":$n[7].Tweener,"p":[$n[4].Graphic,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$1","rt":$n[7].Tweener,"p":[$n[4].Image,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOBlendableColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOBlendableColor$2","rt":$n[7].Tweener,"p":[$n[4].Text,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Graphic,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$1","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Image,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$2","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Outline,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[1].Color,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOColor$3","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Text,$n[1].Color,$n[0].Single]},{"a":2,"n":"DOCounter","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"fromValue","pt":$n[0].Int32,"ps":1},{"n":"endValue","pt":$n[0].Int32,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"addThousandsSeparator","dv":true,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"culture","dv":null,"o":true,"pt":$n[9].CultureInfo,"ps":5}],"sn":"DOCounter","rt":$n[6].TweenerCore$3(System.Int32,System.Int32,DG.Tweening.Plugins.Options.NoOptions),"p":[$n[4].Text,$n[0].Int32,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[9].CultureInfo]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].CanvasGroup,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade","rt":$n[6].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[1].CanvasGroup,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Graphic,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$1","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Graphic,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$2","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$3","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Outline,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFade","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFade$4","rt":$n[6].TweenerCore$3(UnityEngine.Color,UnityEngine.Color,DG.Tweening.Plugins.Options.ColorOptions),"p":[$n[4].Text,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFillAmount","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOFillAmount","rt":$n[6].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[4].Image,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOFlexibleSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOFlexibleSize","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOGradientColor","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Image,"ps":0},{"n":"gradient","pt":pc.ColorGradient,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOGradientColor","rt":$n[7].Sequence,"p":[$n[4].Image,pc.ColorGradient,$n[0].Single]},{"a":2,"n":"DOHorizontalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOHorizontalNormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOJumpAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"jumpPower","pt":$n[0].Single,"ps":2},{"n":"numJumps","pt":$n[0].Int32,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOJumpAnchorPos","rt":$n[7].Sequence,"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOMinSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOMinSize","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DONormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DONormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPivot","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivot","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single]},{"a":2,"n":"DOPivotX","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotX","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPivotY","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOPivotY","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single]},{"a":2,"n":"DOPreferredSize","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].LayoutElement,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOPreferredSize","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].LayoutElement,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOPunchAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"punch","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"elasticity","dv":1.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOPunchAnchorPos","rt":$n[7].Tweener,"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOScale","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Outline,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2}],"sn":"DOScale","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[4].Outline,$n[1].Vector2,$n[0].Single]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","dv":100.0,"o":true,"pt":$n[0].Single,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[7].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos","rt":$n[7].Tweener,"p":[$n[1].RectTransform,$n[0].Single,$n[0].Single,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[7].ShakeRandomnessMode]},{"a":2,"n":"DOShakeAnchorPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"duration","pt":$n[0].Single,"ps":1},{"n":"strength","pt":$n[1].Vector2,"ps":2},{"n":"vibrato","dv":10,"o":true,"pt":$n[0].Int32,"ps":3},{"n":"randomness","dv":90.0,"o":true,"pt":$n[0].Single,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5},{"n":"fadeOut","dv":true,"o":true,"pt":$n[0].Boolean,"ps":6},{"n":"randomnessMode","dv":0,"o":true,"pt":$n[7].ShakeRandomnessMode,"ps":7}],"sn":"DOShakeAnchorPos$1","rt":$n[7].Tweener,"p":[$n[1].RectTransform,$n[0].Single,$n[1].Vector2,$n[0].Int32,$n[0].Single,$n[0].Boolean,$n[0].Boolean,$n[7].ShakeRandomnessMode]},{"a":2,"n":"DOShapeCircle","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"center","pt":$n[1].Vector2,"ps":1},{"n":"endValueDegrees","pt":$n[0].Single,"ps":2},{"n":"duration","pt":$n[0].Single,"ps":3},{"n":"relativeCenter","dv":false,"o":true,"pt":$n[0].Boolean,"ps":4},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":5}],"sn":"DOShapeCircle","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.CircleOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Single,$n[0].Boolean,$n[0].Boolean]},{"a":2,"n":"DOSizeDelta","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].RectTransform,"ps":0},{"n":"endValue","pt":$n[1].Vector2,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOSizeDelta","rt":$n[6].TweenerCore$3(UnityEngine.Vector2,UnityEngine.Vector2,DG.Tweening.Plugins.Options.VectorOptions),"p":[$n[1].RectTransform,$n[1].Vector2,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOText","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Text,"ps":0},{"n":"endValue","pt":$n[0].String,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"richTextEnabled","dv":true,"o":true,"pt":$n[0].Boolean,"ps":3},{"n":"scrambleMode","dv":0,"o":true,"pt":$n[7].ScrambleMode,"ps":4},{"n":"scrambleChars","dv":null,"o":true,"pt":$n[0].String,"ps":5}],"sn":"DOText","rt":$n[6].TweenerCore$3(System.String,System.String,DG.Tweening.Plugins.Options.StringOptions),"p":[$n[4].Text,$n[0].String,$n[0].Single,$n[0].Boolean,$n[7].ScrambleMode,$n[0].String]},{"a":2,"n":"DOValue","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].Slider,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOValue","rt":$n[6].TweenerCore$3(System.Single,System.Single,DG.Tweening.Plugins.Options.FloatOptions),"p":[$n[4].Slider,$n[0].Single,$n[0].Single,$n[0].Boolean]},{"a":2,"n":"DOVerticalNormalizedPos","is":true,"t":8,"pi":[{"n":"target","pt":$n[4].ScrollRect,"ps":0},{"n":"endValue","pt":$n[0].Single,"ps":1},{"n":"duration","pt":$n[0].Single,"ps":2},{"n":"snapping","dv":false,"o":true,"pt":$n[0].Boolean,"ps":3}],"sn":"DOVerticalNormalizedPos","rt":$n[7].Tweener,"p":[$n[4].ScrollRect,$n[0].Single,$n[0].Single,$n[0].Boolean]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUI end.*/
    ...
    /*DG.Tweening.DOTweenModuleUtils+Physics start.*/
    $m("DG.Tweening.DOTweenModuleUtils.Physics", function () { return {"td":$n[7].DOTweenModuleUtils,"att":1048962,"a":2,"s":true,"m":[{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"CreateDOTweenPathTween","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].MonoBehaviour,"ps":0},{"n":"tweenRigidbody","pt":$n[0].Boolean,"ps":1},{"n":"isLocal","pt":$n[0].Boolean,"ps":2},{"n":"path","pt":$n[8].Path,"ps":3},{"n":"duration","pt":$n[0].Single,"ps":4},{"n":"pathMode","pt":$n[7].PathMode,"ps":5}],"sn":"CreateDOTweenPathTween","rt":$n[6].TweenerCore$3(UnityEngine.Vector3,DG.Tweening.Plugins.Core.PathCore.Path,DG.Tweening.Plugins.Options.PathOptions),"p":[$n[1].MonoBehaviour,$n[0].Boolean,$n[0].Boolean,$n[8].Path,$n[0].Single,$n[7].PathMode]},{"at":[new UnityEngine.Scripting.PreserveAttribute()],"a":2,"n":"HasRigidbody","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Component,"ps":0}],"sn":"HasRigidbody","rt":$n[0].Boolean,"p":[$n[1].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"HasRigidbody2D","is":true,"t":8,"pi":[{"n":"target","pt":$n[1].Component,"ps":0}],"sn":"HasRigidbody2D","rt":$n[0].Boolean,"p":[$n[1].Component],"box":function ($v) { return Bridge.box($v, System.Boolean, System.Boolean.toString);}},{"a":2,"n":"SetOrientationOnPath","is":true,"t":8,"pi":[{"n":"options","pt":$n[10].PathOptions,"ps":0},{"n":"t","pt":$n[7].Tween,"ps":1},{"n":"newRot","pt":$n[1].Quaternion,"ps":2},{"n":"trans","pt":$n[1].Transform,"ps":3}],"sn":"SetOrientationOnPath","rt":$n[0].Void,"p":[$n[10].PathOptions,$n[7].Tween,$n[1].Quaternion,$n[1].Transform]}]}; }, $n);
    /*DG.Tweening.DOTweenModuleUtils+Physics end.*/
